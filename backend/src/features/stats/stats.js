...
import { attention, endOfWeek } from '../../shared/score.js';
...
const resolveGroup = g => (Object.hasOwn(GROUPS, g) ? g : ALIASES[g]);
const isGroup = g => !!resolveGroup(g);
const isScope = s => Object.hasOwn(SCOPES, s);
const isRange = r => Object.hasOwn(RANGES, r);
